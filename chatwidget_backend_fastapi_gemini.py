...
# Tự động hỗ trợ tiếng Việt không bị lỗi font trên terminal Windows
...
if __name__ == "__main__":
    ...
    print("=" * 70 + "\n")
    uvicorn.run("chatwidget_backend_fastapi_gemini:app", host="127.0.0.1", port=8000, reload=True)